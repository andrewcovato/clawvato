...
const CLASSIFIER_PROMPT = `You are a complexity classifier for a personal AI assistant. Given a user message, decide whether it needs the FAST path or HEAVY path.
